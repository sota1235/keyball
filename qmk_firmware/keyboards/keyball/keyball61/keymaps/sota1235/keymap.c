...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_universal(
    ...
    _______  , KC_LCTL  , KC_LALT  , KC_LGUI,LT(1,KC_LGUI),LT(2,KC_SPC),LT(3,KC_RGUI),      KC_BSPC,LT(2,KC_ENT),LT(1,KC_LNG2),KC_RGUI, _______  , KC_RALT  , KC_PSCR
  ),
  ...
  [2] = LAYOUT_universal(
    ...
    _______  , _______  , KC_4     , KC_5     , KC_6     ,S(KC_SCLN),                                  KC_PGUP  , _______  , _______  , _______  , KC_BTN3  , _______  ,
    _______  , _______  , KC_1     , KC_2     , KC_3     ,S(KC_MINS), S(KC_8)  ,            S(KC_9)  , KC_PGDN  , _______  , _______  , _______  , _______  , _______  ,
    _______  , _______  , KC_0     , KC_DOT   , KC_LNG2  , _______  , KC_LNG1  ,             KC_DEL  , _______  , _______  , _______  , _______  , _______  , _______
  ),
